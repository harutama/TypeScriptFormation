...
var instancetype: AWS.Parameter = new AWS.Parameter("InstanceType", AWS.ParameterTypes.String);
...
var arch2ami: AWS.Mapping = new AWS.Mapping("AWSRegionArch2AMI");
...
spFoundation.setInstanceType(instancetype.createRef());
{
    ...
    var findAmi: AWS.Function.FindInMap = new AWS.Function.FindInMap(arch2ami, AWS.Function.Ref.Region, findArch);
...
{
    var cmd: AWS.Function.Join = new AWS.Function.Join("");
    cmd.add("<script>\n");
